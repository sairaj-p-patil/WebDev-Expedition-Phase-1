...
---
<p> <b> <i> Note: The Commits are Low on this repo Beacause commits replace my new ones due to accident pushing the code with "git push -u origin main --force" command </i> <b/> </p>
...
- Practice clean and scalable code
